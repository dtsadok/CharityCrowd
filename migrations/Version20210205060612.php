...
final class Version20210205060612 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE nomination (id INT NOT NULL, member_id_id INT NOT NULL, name VARCHAR(255) NOT NULL, pitch TEXT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_872662181D650BA4 ON nomination (member_id_id)');
        $this->addSql('CREATE TABLE vote (id INT NOT NULL, member_id INT NOT NULL, nomination_id INT NOT NULL, value VARCHAR(1) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE nomination ADD CONSTRAINT FK_872662181D650BA4 FOREIGN KEY (member_id_id) REFERENCES member (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
